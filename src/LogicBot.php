...
・今日の決めた時刻に何かをしてほしい依頼だったら、{$Command::AddOneTimeTrigger->value}を
・毎日決めた時刻に何かをしてほしい依頼だったら、{$Command::AddDaiyTrigger->value}を
・その他だと思ったら、9を
返してください。
...
・学校の先生になって　→　2
・武士になって　→　2
・7時半にお知らせメッセージを送って　→　{$Command::AddOneTimeTrigger->value}
・30分後に料理ができたと教えて　→　{$Command::AddOneTimeTrigger->value}
・毎日朝7時におはようメッセージを送って　→　{$Command::AddDaiyTrigger->value}
・あなたの趣味は？　→　9
・天気予報を教えて　→　9
EOM;
