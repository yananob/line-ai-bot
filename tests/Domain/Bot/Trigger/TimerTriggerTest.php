...
final class TimerTriggerTest extends TestCase
{
    ...
    public function testShouldRunNowHandlesEverydayCorrectly(): void
    {
        ...
        Carbon::setTestNow(Carbon::parse("2023-01-01 10:05:00", new \DateTimeZone(Consts::TIMEZONE)));
        $this->assertTrue($trigger->shouldRunNow(10), "Should run within interval");
        
        Carbon::setTestNow(Carbon::parse("2023-01-01 10:09:59", new \DateTimeZone(Consts::TIMEZONE)));
        $this->assertTrue($trigger->shouldRunNow(10), "Should run at end of interval");

        Carbon::setTestNow(Carbon::parse("2023-01-01 10:10:00", new \DateTimeZone(Consts::TIMEZONE)));
        $this->assertFalse($trigger->shouldRunNow(10), "Should not run outside interval");

        Carbon::setTestNow(Carbon::parse("2023-01-01 09:59:59", new \DateTimeZone(Consts::TIMEZONE)));
    ...
    public function testShouldRunNowHandlesTodayCorrectly(): void
    {
        ...
        Carbon::setTestNow(Carbon::parse("2023-05-10 12:00:00", new \DateTimeZone(Consts::TIMEZONE)));

        // Now, set the "current time" for specific assertions
        Carbon::setTestNow(Carbon::parse("2023-05-10 14:30:00", new \DateTimeZone(Consts::TIMEZONE)));
        $this->assertTrue($trigger->shouldRunNow(5));
        
        Carbon::setTestNow(Carbon::parse("2023-05-10 14:34:59", new \DateTimeZone(Consts::TIMEZONE)));
        $this->assertTrue($trigger->shouldRunNow(5));

        Carbon::setTestNow(Carbon::parse("2023-05-10 14:35:00", new \DateTimeZone(Consts::TIMEZONE)));
        $this->assertFalse($trigger->shouldRunNow(5));

        // Different day (relative to the initial setTestNow for "today")
        Carbon::setTestNow(Carbon::parse("2023-05-11 14:30:00", new \DateTimeZone(Consts::TIMEZONE)));
        $this->assertFalse($trigger->shouldRunNow(5));
    }
    ...
    public function testShouldRunNowHandlesSpecificDateCorrectly(): void
    {
        ...
        Carbon::setTestNow(Carbon::parse("2023-06-15 08:00:00", new \DateTimeZone(Consts::TIMEZONE)));
        $this->assertTrue($trigger->shouldRunNow(15));

        Carbon::setTestNow(Carbon::parse("2023-06-15 08:14:59", new \DateTimeZone(Consts::TIMEZONE)));
        $this->assertTrue($trigger->shouldRunNow(15));
        
        Carbon::setTestNow(Carbon::parse("2023-06-15 08:15:00", new \DateTimeZone(Consts::TIMEZONE)));
        $this->assertFalse($trigger->shouldRunNow(15));

        Carbon::setTestNow(Carbon::parse("2023-06-14 08:00:00", new \DateTimeZone(Consts::TIMEZONE)));
        $this->assertFalse($trigger->shouldRunNow(15));
    }
    ...
    public function testShouldRunNowHandlesTomorrowCorrectly(): void
    {
        ...
        Carbon::setTestNow(Carbon::parse("2023-07-01 10:00:00", new \DateTimeZone(Consts::TIMEZONE)));
        
        // Test time on the actual "tomorrow" (2023-07-02)
        $testTimeOnActualTomorrow = Carbon::parse("2023-07-02 11:00:00", new \DateTimeZone(Consts::TIMEZONE));
        ...
        Carbon::setTestNow(Carbon::parse("2023-07-01 11:00:00", new \DateTimeZone(Consts::TIMEZONE)));
