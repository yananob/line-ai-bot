...
final class WebSearchToolTest extends TestCase // TestCaseの完全修飾名を使用 (useしたのでこれでOK)
{
    ...
    private string $testOpenAiModel = 'gpt-5-mini'; // responses()->create() をサポートするモデル
    ...
    public function test_検索が成功する(): void
    {
        ...
        $this->mockResponsesResource->expects($this->once())
            ...
            ->with($this->callback(function ($params) {
                $this->assertArrayHasKey('reasoning_effort', $params);
                $this->assertEquals('none', $params['reasoning_effort']);
                return true;
            }))
